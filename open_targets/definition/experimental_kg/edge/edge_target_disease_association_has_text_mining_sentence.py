...
edge_target_disease_association_has_text_mining_sentence: Final[AcquisitionDefinition[EdgeInfo]] = (
    ExpressionEdgeAcquisitionDefinition(
        ...
        label="TARGET_DISEASE_ASSOCIATION_EVIDENCED_BY_HAS_TEXT_MINING_SENTENCE",
        properties=[],
    )
)
